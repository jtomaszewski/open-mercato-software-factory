...
const logger = createLogger('factory').child({ subscriber: 'order-fulfilled' })

export const metadata = {
  event: 'factory.order.fulfilled',
  persistent: true,
 ...
 * factory agent, whose run adds the customer as a reference on the website. Scope comes from
