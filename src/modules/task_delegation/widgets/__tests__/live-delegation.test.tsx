...
function item(runState: 'starting' | 'running'): TaskDelegationReadItem {
  return { taskId: 'task', projectId: 'project', taskUpdatedAt: 'version', assigneeStaffMemberId: null, assigneeName: null, delegation: { id: 'delegation', delegateUserId: 'agent', delegateName: 'Developer', releasedAt: null, updatedAt: 'version', startedAt: '2026-09-19T11:48:00.000Z', processInstanceId: null, links: [], outcome: null, closeReason: null, runState } }
}
