...
import { DEVELOPER_AGENT_ID, RESEARCHER_AGENT_ID } from './lib/agents'
...
export const WEBSITE_CHANGE_PROMPT = [
  'WEBSITE AND CODE CHANGE HANDOFF',
  `When the operator asks for a website or code change, call ${REQUEST_CHANGE_TOOL}.`,
...
// checkout `code_changes` prepares itself, so the runtime's own attachment/artifact sandbox stays
