...
type Link = { id: string; repositoryId: string; fullName: string; status: 'active' | 'disabled'; isDefault: boolean; updatedAt: string }
type Option = { id: string; fullName: string; status: 'active' | 'disabled' }
