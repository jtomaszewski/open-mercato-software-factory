...
|---|---|---|---|
| 0:00–0:35 | **1. Hook** | Slajd: Norbert (28 mln zł rocznie, 35 osób, 0 programistów), jego strona, która jeszcze nie wie o wczorajszej sprzedaży, agencja „dwa tygodnie na każdą poprawkę”, a dane firmy już w Open Mercato. | problemu, w jednej osobie |
...
**Norbert, właściciel Metal Zbiorniki** (Jarocin, realizacje od 2008, klienci przemysłowi tej skali
co Viessmann, Saint-Gobain czy Grupa Kęty). Prowadzi sprzedaż, katalog i pracowników w Open Mercato. Strona firmy to
