...
|---|---|---|---|
| 0:00–0:35 | **1. Hook** | Slajd: Norbert (28 mln zł rocznie, 35 osób, 0 programistów), jego strona z nieaktualną sekcją „Od ręki”, agencja „dwa tygodnie na każdą poprawkę”, a dane firmy już w Open Mercato. | problemu, w jednej osobie |
